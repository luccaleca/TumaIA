    ...
    <div className="bg-background text-foreground">
            ...
            {authReady && usuarioNome ? (
              <>
                <span className="hidden text-sm text-muted-foreground md:inline">
                  Olá, <strong className="text-foreground">{usuarioNome}</strong>
                </span>
                <Link
                  className="rounded-lg border border-border bg-surface px-3 py-1.5 text-sm text-foreground transition-colors hover:border-foreground/25"
                  href="/painel"
                >
                  Área do usuário
                </Link>
              ...
              <>
                <Link
                  className="rounded-lg border border-border bg-transparent px-3 py-1.5 text-sm text-foreground transition-colors hover:border-foreground/25"
                  href="/login"
                >
                  Entrar
                </Link>
      ...
      <main className="scroll-smooth">
          ...
          <div className="rounded-3xl border border-border bg-surface p-8 shadow-[0_0_60px_-12px_rgba(57,255,20,0.08)] md:p-12">
            <div className="grid grid-cols-1 items-center gap-8 lg:gap-12 md:grid-cols-2">
              <div className="order-1 min-w-0">
                ...
                <h1 className="mt-3 max-w-3xl text-4xl font-bold leading-tight text-foreground md:text-5xl">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  <a
                    href="#planos"
                    className="rounded-lg border border-border bg-surface-elevated px-4 py-2 text-sm font-medium text-foreground transition-colors hover:border-foreground/25"
                  >
                    Ver planos
                  </a>
                </div>
              ...
              <div className="order-2 w-full max-w-md justify-self-center md:max-w-none md:justify-self-end">
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl shadow-[0_0_30px_rgba(0,255,0,0.2)] ring-1 ring-white/5">
                  ...
                  />
                  <div
                    className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-t from-black/50 via-black/15 to-transparent"
                    aria-hidden
                  />
                </div>
              </div>
        ...
        <section id="produto" className="landing-section mx-auto w-full max-w-6xl px-6 py-12">
          <h2 className="section-title text-4xl font-semibold text-foreground md:text-5xl">Como o TumaIA funciona</h2>
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:mt-10 md:grid-cols-3">
            <article className="rounded-xl border border-border bg-surface p-5">
              <h3 className="font-semibold text-foreground">Conexão Direta</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Integre o TumaIA diretamente ao seu WhatsApp de forma simples e rápida.
              </p>
            </article>
            <article className="rounded-xl border border-border bg-surface p-5">
              <h3 className="font-semibold text-foreground">Criação com IA</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Nossa inteligência artificial gera legendas persuasivas e imagens otimizadas para o seu nicho.
              </p>
            </article>
            <article className="rounded-xl border border-border bg-surface p-5">
              <h3 className="font-semibold text-foreground">Postagem Automática</h3>
              <p className="mt-2 text-sm text-muted-foreground">
        ...
        <section id="planos" className="landing-section mx-auto w-full max-w-6xl px-6 py-12">
          <h2 className="section-title text-4xl font-semibold text-foreground md:text-5xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <article className="rounded-xl border border-border bg-surface p-6">
              ...
              <h3 className="mt-1 text-2xl font-semibold text-foreground">Starter</h3>
              <p className="mt-2 text-sm text-muted-foreground">Ideal para quem está começando a estruturar as redes sociais.</p>
            </article>
            <article className="rounded-xl border-2 border-accent bg-surface-elevated p-6 shadow-[0_0_40px_-8px_rgba(57,255,20,0.35)]">
              ...
              <h3 className="mt-1 text-2xl font-semibold text-foreground">Pro</h3>
              <p className="mt-2 text-sm text-muted-foreground">Automação completa para quem quer presença digital diária.</p>
            </article>
          </div>
          <div className="mt-6 rounded-xl border border-border bg-surface p-6">
            <h3 className="text-xl font-semibold text-foreground">Comparativo de benefícios</h3>
            <div className="mt-4 overflow-x-auto">
              <table className="w-full min-w-[700px] border-separate border-spacing-0 text-left text-sm">
                <thead>
                  <tr>
                    <th className="border-b border-border py-2 pr-4 font-semibold text-foreground">Recurso</th>
                    <th className="border-b border-border py-2 pr-4 font-semibold text-foreground">Starter</th>
                    <th className="border-b border-border py-2 pr-4 font-semibold text-foreground">Pro</th>
                    <th className="border-b border-border py-2 font-semibold text-foreground">Business</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={row[0]}>
                      <td className="border-b border-border py-2 pr-4 text-foreground">{row[0]}</td>
                      <td className="border-b border-border py-2 pr-4 text-muted-foreground">{row[1]}</td>
                      <td className="border-b border-border py-2 pr-4 text-muted-foreground">{row[2]}</td>
                      <td className="border-b border-border py-2 text-muted-foreground">{row[3]}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section id="depoimentos" className="landing-section mx-auto w-full max-w-6xl px-6 py-12">
          <h2 className="section-title text-4xl font-semibold text-foreground md:text-5xl">O que nossos clientes dizem</h2>
          <p className="mt-3 max-w-4xl text-muted-foreground">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            {depoimentos.map((d) => (
              <article key={d.nome} className="rounded-xl border border-border bg-surface p-5">
                ...
                <p className="mt-3 text-sm font-medium text-foreground">{d.nome}</p>
        ...
        <section id="faq" className="landing-section mx-auto w-full max-w-6xl px-6 py-12">
          <h2 className="section-title text-4xl font-semibold text-foreground md:text-5xl">Dúvidas Comuns</h2>
          <div className="mt-6 space-y-3">
            {faqItems.map((item, idx) => (
              <details
                key={item.q}
                className="group rounded-xl border border-border bg-surface p-4 open:border-foreground/30"
              >
        ...
        <section id="quem-somos" className="landing-section mx-auto w-full max-w-6xl px-6 py-12">
          <h2 className="section-title text-4xl font-semibold text-foreground md:text-5xl">Nossa História</h2>
          <p className="mt-3 max-w-4xl text-muted-foreground">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <article className="rounded-xl border border-border bg-surface p-5">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Inovação, simplicidade e foco total no sucesso do cliente.</p>
            </article>
          </div>
        </section>
        ...
        <section className="mx-auto w-full max-w-6xl px-6 pb-16 pt-8">
          <div className="rounded-2xl border border-accent/40 bg-surface-elevated p-8 shadow-[0_0_48px_-12px_rgba(57,255,20,0.25)]">
            <h2 className="text-3xl font-semibold text-foreground">Pronto para revolucionar seu Instagram?</h2>
